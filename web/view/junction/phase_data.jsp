...
<html>
    ...
    <body onload="generate_table('${side_no}', '${no_of_phase}','${day_select}','${date_select}','${junction_name}','${on_off_time_select}')" id="mainBody">
...
debugger;
            function generate_table(side_no, no_of_phase,day_select,date_select, junction_name,on_off_time_select) {
