...
<html>
    <head>
        ...
        <title>Data Entry: Camera Type Table</title>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function makeEditable(id) {
                document.getElementById("camera_type_id").disabled = false;
            ...
            function verify() {
               ...
               if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
                    ...
                    if(myLeftTrim(camera_type).length == 0) {
                        document.getElementById("message").innerHTML = "<td colspan='5' bgcolor='coral'><b>camera type is required...</b></td>";
                        document.getElementById("camera_type").focus();
                ...
                <td>
                    <DIV id="body" class="maindiv" >
                        <table align="center" width="1000" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <DIV STYLE="overflow: auto; width: 400px; max-height: 410px; padding:0px; margin-bottom: 20px; margin-top:20px">
                                            <table id="rcorners3" align="center" class="reference">
                                                <tr>
                                                    ...
                                                    <th class="heading" colspan="3">Camera Type</th>
                                                    <th class="heading" colspan="3">Remark</th>
                                                </tr>
                                                <c:forEach var="camera_type" items="${requestScope['camera_typeList']}" varStatus="loopCounter">
                                                    <tr class="row" onMouseOver=this.style.backgroundColor='#E3ECF3' onmouseout=this.style.backgroundColor='white'>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" style="display: none">${camera_type.camera_type_id}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" colspan="3">${camera_type.camera_type}</td>
                                                         <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" colspan="3">${camera_type.remark}</td>
                                                    </tr>
                                                </c:forEach>
                                                <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <form name="form3" method="POST" action="CameraTypeCont" onsubmit="return verify()">
                                        <DIV STYLE="overflow: auto; width: 800px;padding:0px; margin: 0px">
                                            <table class="divv" border="1" border-color="blue">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="heading">Camera_Type</th><td><input class="input" type="text" id="camera_type" name="camera_type" size="38" value="" disabled></td>
                                                ...
                                                <input type="hidden" id="camera_type_id" name="camera_type_id" value="" disabled>
                                                <input type="hidden" name="lowerLimit" value="${lowerLimit}">
